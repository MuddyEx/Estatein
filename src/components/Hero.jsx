        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-10 lg:grid-cols-2">
            <div>
              ...
              <Button className="bg-[#703BF7] text-white px-6 py-5 mt-8 rounded-full hover:bg-purple-600">
                Get Started
              </Button>

              <p className="mt-5 text-white">Already joined us? <a href="#" className="text-[#703BF7] hover:underline">Log in</a></p>
              <Stats /> 
            </div>
